...
A goal for the BetterJSONStorage project is to provide a drop in replacement for the default JSONStorage. Any deviation from the behavior of the reference JSONStorage is considered a bug.
